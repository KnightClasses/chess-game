...
RSpec.describe PiecesController, type: :controller do
  describe "pieces#update action" do
    it "should allow a user to successfully move (update x/y) a piece" do
      ...
      piece = game.find_one_piece_in_game(x:1,y:2,type:"Pawn")
      req_x = piece.x
      req_y = piece.y + 1
    ...
    it "should do nothing if the moving piece is not the player_turn's piece" do
      game = FactoryGirl.create(:game)
      pawn = game.find_one_piece_in_game(type:"Knight",color:"Black",x:2,y:8)
  ...
  describe "pieces#promote_pawn" do
    it "should allow us to promote the pawn if promotable" do
      ...
      pawn = game.find_one_piece_in_game(type:"Pawn",color:"White",x:8,y:7)
      ...
      queens = game.find_pieces_in_game(type:"Queen",color:"White")
